...
//MxPluginPort_TrackProperty_GetDataで使用する定義
//========================================
#define		tp_2DHoldAspect 0			//アスペクト比保持
...
typedef enum TTextPropertyType_t {
	...
	cp_Text_LineCount = 0x26	//テキストキャストの行数(取得のみ)
} TTextPropertyType;
...
//======================================================================================//
//MxPluginPort_Project_SetPropertyInt、MxPluginPort_Project_GetPropertyIntで使用する定義//
//======================================================================================//
...
BOOL MxPluginPort_Event_ScoreRename_GetNumber(HINSTANCE hinstDLL, int* ScoreNum);												//スコア名変更イベントが発生した際の、スコア番号
BOOL MxPluginPort_Event_ScoreRename_GetOldName(HINSTANCE hinstDLL, char** OldName);												//スコア名変更イベントが発生した際の、古いスコア名
BOOL MxPluginPort_Event_ScoreRename_GetNewName(HINSTANCE hinstDLL, char** NewName);												//スコア名変更イベントが発生した際の、新しいスコア名
